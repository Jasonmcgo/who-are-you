...
export const questions: Question[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "fe", label: "Voice D", voice: "Voice D", quote: `"The people carrying this work are paying for the plan's failure too. Before we fix the plan, I want to tend to what this is costing them."`, example: "I see what this is costing the people I'm working with; I want to tend to them before we figure out the next move on the plan.", signal: "fe" },
    ],
  },
  {
    question_id: "Q-T6",
  ...
  },
  {
    ...
    items: [
      ...
      { id: "fe", label: "Voice B", voice: "Voice B", quote: `"Whatever I decide, someone bears the cost and someone gets protected. I want to know which person each option chooses for before I make the call."`, example: "Each option protects somebody and asks somebody else to bear the cost; I want to see who's on each side of that before I commit.", signal: "fe" },
