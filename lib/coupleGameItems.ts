...
export const COUPLE_GAME_ITEMS: readonly CoupleGameItemSpec[] = [
  ...
  },
  {
    ...
    sourceSignal: "grip_pattern",
    options: [
      { id: "calming_yourself", label: "calming yourself", labelAboutPartner: "calming {S_refl}", valence: "critical" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "make_space_for_you", label: "make space for you", labelAboutPartner: "make space for {S_obj}", signalTag: "tenderness_care" },
      { id: "champion_your_goals", label: "champion your goals", labelAboutPartner: "champion {S_poss} goals", signalTag: "championing" },
      { id: "sit_with_you_in_hard_moments", label: "sit with you in hard moments", labelAboutPartner: "sit with {S_obj} in hard moments", signalTag: "tenderness_care" },
      { id: "are_honest_with_you", label: "are honest with you", labelAboutPartner: "are honest with {S_obj}", signalTag: "devotion_to_calling" },
      { id: "make_you_laugh", label: "make you laugh", labelAboutPartner: "make {S_obj} laugh", signalTag: "fun_adventure" },
      { id: "build_something_with_you", label: "build something with you", labelAboutPartner: "build something with {S_obj}", signalTag: "building_construction" },
    ],
