...
> = {
  "T-013": {
    cost: "The 3 C's question for your shape is sharper than 'do you donate enough to ${value} causes.' It is whether your protected hours, creative output, and strategic attention are moving toward what ${value} would actually require — or whether maintenance is consuming the resources that were supposed to build that.",
    coverage: "The 3 C's question for your shape is sharper than 'do you give enough to ${value} causes.' It is whether the people through whom ${value} actually shows up — the ones you spend relational presence on, the ones whose lives your money lands inside — are the people ${value} would name if it could choose for itself, or whether the relational gravity has settled somewhere else.",
    compliance: "The 3 C's question for your shape is sharper than 'do you donate enough to ${value} causes.' It is whether the risks you actually protect against, and the protections you actually fund, are aligned with what ${value} says is worth losing sleep over — or whether your risk register has drifted toward the threats your shape is wired to over-rate.",
    balanced: "The 3 C's question for your shape is whether ${value}, named as one of your most sacred values, is actually getting any meaningful share of the resources that compose a life — money, time, attention, presence — or whether it sits in the named-but-unfunded register that almost every adult life has, and that almost every adult life regrets in the long arc.",
  },
  "T-014": {
    cost: "The 3 C's question for your shape is sharper than 'are you spending energy on the right cause.' It is whether your best hours — the ones where attention compounds — are moving toward ${value}, or whether ${value} is what you intend to get to once the maintenance load lets up. The candidate move: give ${value} a scheduled claim on the best hour you reliably control, not only the leftover hour.",
    coverage: "The 3 C's question for your shape is sharper than 'are you spending energy on the right cause.' It is whether the relational presence ${value} would actually require — sustained attention to specific people whose lives ${value} would have you tend — is what your discretionary energy lands on, or whether it lands on the broader-but-thinner register of being-near-many. The candidate move: name one specific person ${value} would have you give your best energy to this season, and check whether that person actually gets it.",
    compliance: "The 3 C's question for your shape is sharper than 'are you spending energy on the right cause.' It is whether the watchful, protective, holding-against-bad-outcomes work that ${value} would have you do is where your discretionary energy actually lands, or whether it lands on lower-stakes vigilance that the same wiring also rewards. The candidate move: ask which protection ${value} most wants from you this season, and give it the best of what you have.",
    balanced: "The 3 C's question for your shape is whether ${value}, named as central, is getting any of your best energy at all — or whether the energy ${value} is supposed to organize is getting absorbed by everything else and arriving to ${value} in whatever shape leftover allows. The candidate move: give ${value} a scheduled claim on your best energy, not only your leftover energy.",
  },
  "T-015": {
    cost: "The 3 C's question for your shape, across multiple allocation domains, is sharper than 'are your stated and lived priorities aligned.' It is whether the protected hours, creative output, and strategic attention you control are moving toward the kind of life you'd build if you were building it on purpose — or whether maintenance, obligation, and inertia are consuming the resources that were supposed to build that. Does this feel true, partially true, or not true at all?",
    coverage: "The 3 C's question for your shape, across multiple allocation domains, is sharper than 'are your stated and lived priorities aligned.' It is whether the people, communities, and relationships you actually invest in are the ones a life-built-on-purpose would invest in — or whether the relational gravity has settled onto people the present demands rather than people the future would have you stay close to. Does this feel true, partially true, or not true at all?",
    compliance: "The 3 C's question for your shape, across multiple allocation domains, is sharper than 'are your stated and lived priorities aligned.' It is whether the protections you fund, the risks you actually mitigate, and the threats you actually hold against are calibrated to the life you'd build on purpose — or whether your risk register is shaped more by the threats your wiring over-rates than by the threats a clear-eyed read would actually flag. Does this feel true, partially true, or not true at all?",
    balanced: "The 3 C's question for your shape, across multiple allocation domains, is whether the lived shape of your week — money, time, attention, relational presence, risk-protection — is the shape of the life you'd build if you were building it on purpose, or whether it's the shape that emerged from a long sequence of adjacent reasonable choices. The honest read is rarely all-aligned and rarely all-misaligned; it's specific. Does this feel true, partially true, or not true at all?",
  },
};
